...
public class NativeLibrary
{
    ...
    public static native Pointer nn_allocmsg(SizeT size, int type);

    public static native int nn_freemsg(Pointer msg);

    public static native int nn_sendmsg(int s, MessageHeader.ByReference header, int flags);

    public static native int nn_recvmsg(int s, MessageHeader.ByReference header, int flags);
